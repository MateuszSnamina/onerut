...
namespace onerut_scalar {
    ...
    template<typename ReturnTag, typename Arg1, typename Callable>
    class UnaryFunction : public CommonInterface<typename ReturnTag::OnerutBaseType > {
    public:
        static_assert(IsArg<Arg1>::value);
        using U1 = typename Arg1::OnerutBaseType;
        UnaryFunction(Callable callable, std::shared_ptr<U1> arg);
    ...
    template<typename ReturnTag, typename Arg1, typename Callable>
    UnaryFunction<ReturnTag, Arg1, Callable>::UnaryFunction(
    ...
    UnaryFunction<ReturnTag, Arg1, Callable>::value() const {
    ...
    template<typename ReturnTag, typename Arg1, typename Arg2, typename Callable>
    class BinaryFunction : public CommonInterface<typename ReturnTag::OnerutBaseType > {
    public:
        static_assert(IsArg<Arg1>::value);
        static_assert(IsArg<Arg2>::value);
        using U1 = typename Arg1::OnerutBaseType;
        using U2 = typename Arg2::OnerutBaseType;
        BinaryFunction(Callable callable, std::shared_ptr<U1> first_arg, std::shared_ptr<U2> second_arg);
        typename ReturnTag::BuildInCppType value() const final;
    private:
        Callable callable;
    ...
    template<typename ReturnTag, typename Arg1, typename Arg2, typename Callable>
    BinaryFunction<ReturnTag, Arg1, Arg2, Callable>::BinaryFunction(
    ...
    template<typename ReturnTag, typename Arg1, typename Arg2, typename Callable>
    typename ReturnTag::BuildInCppType
    BinaryFunction<ReturnTag, Arg1, Arg2, Callable>::value() const {
    ...
    template <class Return, class Callable, class Arg1>
    class Function<Return, Callable, Arg1> : public UnaryFunction<Return, Arg1, Callable> {
    public:
        static_assert(IsArg<Arg1>::value);
        using U1 = typename Arg1::OnerutBaseType;

        Function(Callable callable, std::shared_ptr<U1> arg) :
        UnaryFunction<Return, Arg1, Callable>(callable, arg) {

        }

    };

    template <class Return, class Callable, class Arg1, class Arg2>
    class Function<Return, Callable, Arg1, Arg2> : public BinaryFunction<Return, Arg1, Arg2, Callable> {
    public:
        static_assert(IsArg<Arg1>::value);
        static_assert(IsArg<Arg2>::value);
        using U1 = typename Arg1::OnerutBaseType;
        ...
        BinaryFunction<Return, Arg1, Arg2, Callable>(callable, first_arg, second_arg) {
        }
    };
