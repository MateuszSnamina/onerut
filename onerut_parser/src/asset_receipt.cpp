...
namespace onerut_parser {
    ...
    void print_receipt(std::ostream& stream, const Asset& asset, std::string line_prefix) {
        ...
        if (asset.deref().is_empty()) {
            ...
            //            stream << line_prefix << "[asset-deref] " << "value = " << result_integer->value_integer() << std::endl;
            ...
            //            stream << onerut_normal_operator::to_string(*op, line_prefix + "[asset-deref] "); //TODO to_string change to operator<<
            ...
            //            stream << onerut_normal_operator::to_string(*eigs, line_prefix + "[asset-deref] "); //TODO to_string change to operator<<
