...
namespace onerut_parser_exec::onerut_gramma {
    ...
    struct IdentifierParser : annotate_position {
    };
    ...
    boost::spirit::x3::rule< IdentifierParser, onerut_ast::x3::IdentifierInfo > const identifier_parser = "identifier";
    ...
    auto const function_parser_def = identifier_parser >> '(' >> expression_parser % ',' >> ')';
    auto const empty_function_parser_def = identifier_parser >> '(' >> ')';
    auto const identifier_parser_def = boost::spirit::x3::lexeme[boost::spirit::x3::char_("A-Za-z_") >> *boost::spirit::x3::char_("A-Za-z0-9_")];
    ...
    BOOST_SPIRIT_DEFINE(
            ...
            op_unary_plus_minus_parser,
            value2_parser,
            function_parser, empty_function_parser, identifier_parser,
