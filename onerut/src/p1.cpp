...
void temp_testing() {
    ...
    lines.push_back(std::make_shared<const std::string>("DOMAIN := kron_domain(EL_DOMAIN , MU_DOMAIN, TA_DOMAIN  )"));
    lines.push_back(std::make_shared<const std::string>("E := eye(DOMAIN)"));
    lines.push_back(std::make_shared<const std::string>("VALUE(E)"));
