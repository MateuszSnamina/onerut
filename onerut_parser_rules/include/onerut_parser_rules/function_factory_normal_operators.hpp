...
namespace onerut_parser_rules {
    ...
    class CreateEgDomainFunctionFactory : public NaryFunctionFactory<0> {
        onerut_parser_exec::Asset make_function_otherwise_make_error(std::array<onerut_parser_exec::Asset, 0> args_asset) const override;
    };
    ...
    class CreateFockDomainFunctionFactory : public AbstractFunctionFactory {
